...
3. Vercel detectará automáticamente `index.html` como página principal.
4. Elegí el subdominio que prefieras, por ejemplo: `sonora-museo.vercel.app`.

No requiere instalar dependencias ni ejecutar una compilación.
